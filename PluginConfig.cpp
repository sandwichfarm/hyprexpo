...
void registerHyprexpoConfigValues() {
    ...
    addConfigValue(makeShared<Config::Values::CIntValue>("plugin:hyprexpo:number_keys_select_by_index", "select active overview tiles by number-key position", HyprexpoConfig::NUMBER_KEYS_SELECT_BY_INDEX_DEFAULT));
